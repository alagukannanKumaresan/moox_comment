...
$tx_mooxcomment_domain_model_rating = array(
	'ctrl' => array(
		...
		'iconfile' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath('moox_comment').'Resources/Public/Icons/tx_mooxcomment_domain_model_rating.gif',
		'hideTable' => FALSE,
	),
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, fe_user, title, rating, confirmed',
	),
	'types' => array(
		'1' => array('showitem' => 
			//'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource,'. 
			'fe_user, title, rating, confirmed'.						
...
return $tx_mooxcomment_domain_model_rating;
?>