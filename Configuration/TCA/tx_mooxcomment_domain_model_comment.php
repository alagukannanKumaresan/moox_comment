...
$tx_mooxcomment_domain_model_comment = array(
	'ctrl' => array(
		...
		'iconfile' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath('moox_comment').'Resources/Public/Icons/tx_mooxcomment_domain_model_comment.gif',
		'hideTable' => FALSE,
	),
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, fe_user, title, name, email, comment, confirmed',
	),
	'types' => array(
		'1' => array('showitem' => 
			//'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource,'. 
			'fe_user, title, name, email, comment, confirmed'.						
...
return $tx_mooxcomment_domain_model_comment;
?>